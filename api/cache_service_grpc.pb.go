...
const (
	...
	CacheService_GetPid_FullMethodName                  = "/api.CacheService/GetPid"
	CacheService_GetLeader_FullMethodName               = "/api.CacheService/GetLeader"
	CacheService_GetHeartbeat_FullMethodName            = "/api.CacheService/GetHeartbeat"
	CacheService_UpdateLeader_FullMethodName            = "/api.CacheService/UpdateLeader"
	CacheService_RequestElection_FullMethodName         = "/api.CacheService/RequestElection"
	CacheService_GetClusterConfig_FullMethodName        = "/api.CacheService/GetClusterConfig"
	CacheService_UpdateClusterConfig_FullMethodName     = "/api.CacheService/UpdateClusterConfig"
	CacheService_RegisterNodeWithCluster_FullMethodName = "/api.CacheService/RegisterNodeWithCluster"
)
